...
int main() {
	...
	while (choice != 0) {
		...
		case 6:
			...
			break;
		case 7:
			printf("Please input the element to locate:");
			scanf("%d", &e);
			if (i=LocateElem(temp, e, Equal)) {
				printf("ok,it's the No.%d element.\n",i);
			}
			else {
				printf("wrong\n");
			}
			...
			break;
		case 8:
			printf("Please input the element to find its prior element.\n");
			scanf("%d", &cur_e);
			...
			break;
		case 9:
			printf("Please input the element to fint its next element.\n");
			scanf("%d", &cur_e);
